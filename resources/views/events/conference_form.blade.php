                    ...
                    <div class="card">
                        <div class="card-body consult-form">
                            <form action="{{ url('/') }}">
                                ...
                                <div class="row my-2">
                                    <div class="col-4 my-auto">
                                        <label for="reg_start_date"><b>Дата начала/конца регистрации</b></label>
                                    </div>
                                    <div class="col-4">
                                        <input name="reg_start_date" id="reg_start_date" type="date" class="form-control">
                                    </div>
                                    <div class="col-4">
                                        <input name="reg_end_date" id="reg_end_date" type="date" class="form-control">
                                    </div>
                                </div>
                                <div class="row my-2">
                                    <div class="col-4 my-auto">
                                ...
                                <div class="row my-2">
                                    <div class="col-4 my-auto">
                                        <label for="organizer"><b>Организатор</b></label>
                                    </div>
                                    <div class="col-8">
                                        <input name="organizer" id="organizer" type="text" value="{{ auth()->user()->name }}">
                                    </div>
                                </div>
                                <div class="row my-2">
                                    <div class="col-4 my-auto">
                                ...
                                <div class="row my-2">
                                    <div class="col-4 my-auto">
                                        <label for="location"><b>Место проведения</b></label>
                                    </div>
                                    <div class="col-8">
